"""
Example: train a BioTransformer for fluorescence prediction.
...
DATA_DIR = os.environ.get("TAPE_DATA_DIR", "/path/to/tape/data/fluorescence")
CHECKPOINT_DIR = "checkpoints-fluorescence"
...
if __name__ == "__main__":
    ...
    pretrained = os.path.join(CHECKPOINT_DIR, "fluorescence_blockwise2d.pt")
    run(
        AttentionConfig(
            type="homa",
            block_size=40,
